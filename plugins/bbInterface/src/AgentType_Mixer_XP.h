...
int     agenttype_mixer_create_xp (agent *a, wchar_t *parameterstring);
int     agenttype_mixer_destroy_xp (agent *a);
int     agenttype_mixer_message_xp (agent *a, int tokencount, wchar_t *tokens[]);
...
void    agenttype_mixerscale_menu_set_xp (Menu *m, control *c, agent *a,  wchar_t *action, int controlformat);
void    agenttype_mixerbool_menu_set_xp (Menu *m, control *c, agent *a,  wchar_t *action, int controlformat);
