 ...
 */
/* hash_32.c */
extern Fnv32_t fnv_32_buf(void const * buf, size_t len, Fnv32_t hashval);
extern Fnv32_t fnv_32_str(char const * buf, Fnv32_t hashval);

/* hash_32a.c */
extern Fnv32_t fnv_32a_buf(void const * buf, size_t len, Fnv32_t hashval);
extern Fnv32_t fnv_32a_str(char const * buf, Fnv32_t hashval);

/* hash_64.c */
extern Fnv64_t fnv_64_buf(void const * buf, size_t len, Fnv64_t hashval);
extern Fnv64_t fnv_64_str(char const * buf, Fnv64_t hashval);

/* hash_64a.c */
extern Fnv64_t fnv_64a_buf(void const * buf, size_t len, Fnv64_t hashval);
extern Fnv64_t fnv_64a_str(char const * buf, Fnv64_t hashval);
