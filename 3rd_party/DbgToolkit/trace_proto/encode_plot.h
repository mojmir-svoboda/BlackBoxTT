...
namespace asn1 {
	...
	inline size_t encode_plot (Allocator * allocator, char * buff, size_t buff_ln, trace::level_t level, trace::context_t context, float x, float y, char const * fmt, va_list args)
	{
		Command_t command;
		memset(&command, 0, sizeof(Command));
		command.present = Command_PR_plot;
